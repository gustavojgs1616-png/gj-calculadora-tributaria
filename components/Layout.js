...
const NAV_GRUPOS = [
  ...
  },
  {
    ...
    itens: [
      ...
      { id: "honorarios", label: "Precificação Contábil", tipo: "pagina", href: "/honorarios", icon: "calc" },
      { id: "cnpj",       label: "Consulta Fiscal",      tipo: "pagina", href: "/cnpj",       icon: "search" },
      { id: "documentos", label: "Gerador de Documentos", tipo: "pagina", href: "/documentos", icon: "doc" },
